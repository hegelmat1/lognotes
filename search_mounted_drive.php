...
<?php
    ...
    //path to get the the server root directory
    //This will be a switch depending on the jurisdiction.
    $prefix = "../../../lognotes/";
		//$path           = "files/".$jurisdiction."/".$day;
    $path           = $prefix.$jurisdiction."/".$day;
		echo "</div></div><br><br><br><div class='text-center'>";
		//SHOW FOLDER STRUCTURE , "files/20220531"
		echo "Searching for lognotes in ".$jurisdiction." folder for this date: ".$_POST['day']."</br>";
		echo "This is the path of the file : ".$path;
